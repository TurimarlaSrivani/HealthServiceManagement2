...
public class PatientCaseController {
	...
	public ResponseEntity<PatientCase> deletePatientCase(@PathVariable("patientid") int patientCaseId )throws PatientCaseNotFoundException
	{
	...
	public ResponseEntity<PatientCase> updatePatientCaseById(@PathVariable("patientId") int patientCaseId,@RequestBody PatientCase patientCase) throws PatientCaseNotFoundException
	{
