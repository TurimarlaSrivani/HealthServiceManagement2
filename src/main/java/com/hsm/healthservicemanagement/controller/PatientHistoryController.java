...
public class PatientHistoryController {
	...
	public PatientHistory findByPatientHistoryId(@PathVariable("id") int patientHistoryId)
	{
		if(hs.findByPatientHistoryId(patientHistoryId)==null)
			throw new PatientHistoryNotFoundException("Patient History not found with given patient Id :"+patientHistoryId);
	...
	public PatientHistory updatePatientHistory(@PathVariable("id") int patientHistoryId, @RequestBody PatientHistory his)
	{
		if(hs.findByPatientHistoryId(patientHistoryId)==null)
			throw new PatientHistoryNotFoundException("Patient History not found with given patient Id :"+patientHistoryId);
